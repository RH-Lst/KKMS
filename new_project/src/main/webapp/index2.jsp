...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        <div class="layui-logo layui-hide-xs layui-bg-black">蟹堡王餐厅前台点餐系统</div>
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item"><a href="cartTest.jsp" target="main">点单</a></li>
                <li class="layui-nav-item"><a href="show.jsp" target="main">查看购物车</a></li>
            </ul>
        </div>
    </div>
